...
<div class="row mt-3 align-items-center">
    <div class="col-sm-6 mt-3 mt-md-0" style="max-height: 315px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
        <img src="{{ 'assets/img/ese464/proj0.png' | relative_url }}" alt="Project 0 Robot" class="img-fluid rounded z-depth-1" style="max-height: 315px; width: auto; object-fit: contain;">
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/reWD-8ZdNxg?mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="rounded z-depth-1"></iframe>
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 align-items-center">
    <div class="col-sm-6 mt-3 mt-md-0" style="max-height: 315px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
        <img src="{{ 'assets/img/ese464/proj1.jpg' | relative_url }}" alt="Project 1 Robot" class="img-fluid rounded z-depth-1" style="max-height: 315px; width: auto; object-fit: contain;">
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/kU5IT69bEhU?mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="rounded z-depth-1"></iframe>
    </div>
</div>
<div class="caption">
    Project 1: Autonomous waypoint navigation with mecanum wheels
</div>
...
<div class="row mt-3 align-items-center">
    <div class="col-sm-6 mt-3 mt-md-0" style="max-height: 315px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
        <img src="{{ 'assets/img/ese464/proj2.JPG' | relative_url }}" alt="Project 2 Robot" class="img-fluid rounded z-depth-1" style="max-height: 315px; width: auto; object-fit: contain;">
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/f6ujk4T0HVY?mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="rounded z-depth-1"></iframe>
    </div>
</div>
<div class="caption">
    Project 2: Drawing robot arm in action
</div>
